...
% Does a numFolds-fold cross validation over
% numK different k-values e.g k = 1.. numK
% and choses the best k for given data set.
% Note: if multiple alternatives have the
% same accuracy, lowerst k will be chosen.
[A, k] = xvalidation(numFolds, numK, dataSetNr);
